function Player(controlData) {
    ...
    obj.bindGrid = function(data) {
		for(var i=0; i<data.length; i++) {
            ...
            data[i].hash = data[i].leaderboard.song.hash;
            ...
            //     var difficult = {};
            //     difficult.name = data[i].leaderboard.song.difficulties[j].difficultyName;
            //     difficult.characteristic = data[i].leaderboard.song.difficulties[j].modeName;
            //     data[i].difficulties.push(difficult);
            // }
    ...
    obj.navGrid = function() {
		...
		var callback_navButton_playlist = function() {
            obj.selectedMapIDs = obj.playerContainer.getGridParam("selarrrow");
